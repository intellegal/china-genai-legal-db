...
status: 法律数据库题录核验-官方全文已保存-逐字版本比对待补
---

# 网络信息内容生态治理规定

- 效力：部门规章；国家互联网信息办公室令第5号；2019-12-15公布，2020-03-01施行。
- 关联性：网络内容生产、传播及平台治理的通用规则；第23条明确涉及深度学习等新技术，第12条涉及算法推荐。
- 法律数据库核验：人工智能或算法推荐的部门规章细类检索已保存题录；标题、文号及日期与官方正文版本头一致。
- 来源：[官方发布或转载](https://www.cac.gov.cn/2019-12/20/c_1578375159509309.htm)，bb-browser读取可见正文。
- 完整性：第1—42条连续核验通过；逐字版本比对尚未完成。
