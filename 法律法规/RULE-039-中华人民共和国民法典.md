...
status: 官方全文已保存-法律数据库现行题录及1260条正文比对一致
---

# 中华人民共和国民法典

- 效力：法律；2020-05-28通过，2021-01-01施行。
- 来源：[最高人民法院官方转载](https://www.court.gov.cn/zixun/xiangqing/233181.html)，bb-browser读取可见正文。
- 关联性：已收AI换脸、声音权益、个人信息及服务合同案例的基础法律；涵盖肖像、声音、名誉、隐私、个人信息、网络侵权通知处置以及合同效力和责任。
- 完整性：第1—1260条编号逐一转换后，与连续整数序列核对一致；保留七编与附则全文。
本地官方文本与法律数据库1260条正文逐条比对一致：仅去除空白、编章节标题及法律数据库编辑添加的条旨，保留标点比较，差异0条。比对涵盖款和列项，不涵盖页面排版及编辑注释。
